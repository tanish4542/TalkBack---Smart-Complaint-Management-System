...
React 19, React Router v7, Axios, Tailwind CSS, Framer Motion, React Icons
...
Submit complaints, view history, choose anonymous mode
...
Manage department-specific complaints, respond, update status
...
Cross-department overview, urgent complaint tracking, final resolution
...
Fetch complaints (filter by status)
...
/api/{department}/:id/response



Submit admin response & notify student
...
Dashboard counts (pending, resolved, urgent)
...
/api/principal/pending



All pending complaints across departments
...
/api/principal/urgent



Pending complaints older than 7 days
...
/api/:id/principal-response



Principal resolution with department context
...
description, course, complaint_type, is_anonymous
...
block, roomNumber, text, isAnonymous
