...
import { FaBars, FaUniversity, FaBook, FaBed, FaBus, FaBroom, FaPizzaSlice } from 'react-icons/fa';
...
<header className="home-header flex justify-center items-center p-6 shadow-sm">
  ...
  <div className="logo-center">
    <img
      src="/logo1.png"
      alt="Complaint Box"
      className="complaint-logo h-[150px]"
    />
  </div>
</header>
...
>
  <img
    ...
    />
       ...
       <hr className="separator-line border-gray-450 my-4" />
      ...
      <main className="widget-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-10 py-8">
        {[
          { icon: <FaUniversity size={60} />, name: 'Administration', route: '/admin/administration', color: 'bg-blue-100' },
          { icon: <FaBook size={60} />, name: 'Academics', route: '/admin/academics', color: 'bg-green-100' },
          { icon: <FaBed size={60} />, name: 'Hostel', route: '/admin/hostel', color: 'bg-purple-100' },
          { icon: <FaBus size={60} />, name: 'Transportation', route: '/admin/transportation', color: 'bg-yellow-100' },
          { icon: <FaBroom size={60} />, name: 'Sanitation', route: '/admin/sanitation', color: 'bg-red-100' },
          { icon: <FaPizzaSlice size={60} />, name: 'Food', route: '/admin/food', color: 'bg-red-100' }
        ].map((widget) => (
          <div
            key={widget.name}
